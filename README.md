...
func main() {
    ...
    // you can use Peek method. The Peek method will return
    // the value as well as a boolean indicating whether or not
    // the value is valid. A value will be invalid if the buffer
    // is empty.
